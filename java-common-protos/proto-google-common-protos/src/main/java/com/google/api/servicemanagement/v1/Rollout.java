  ...
  public  static final class TrafficPercentStrategy extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              percentages = input.readMessage(
                  PercentagesDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistry);
              percentages_.getMutableMap().put(percentages.getKey(), percentages.getValue());
              break;
            }
          }
        }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (java.util.Map.Entry<java.lang.String, java.lang.Double> entry
        ...
        com.google.protobuf.MapEntry<java.lang.String, java.lang.Double>
        percentages = PercentagesDefaultEntryHolder.defaultEntry.newBuilderForType()
            .setKey(entry.getKey())
            .setValue(entry.getValue())
            .build();
        output.writeMessage(1, percentages);
      }
    }
    ...
    public int getSerializedSize() {
      ...
      for (java.util.Map.Entry<java.lang.String, java.lang.Double> entry
        ...
        size += com.google.protobuf.CodedOutputStream
            .computeMessageSize(1, percentages);
      }
      memoizedSize = size;
      return size;
    }
    ...
    public static final class Builder extends
      ...
      public Builder removePercentages(
          java.lang.String key) {
        if (key == null) { throw new java.lang.NullPointerException(); }
        getMutablePercentages().remove(key);
        return this;
      }
      /**
      ...
      public Builder putPercentages(
        ...
        getMutablePercentages().put(key, value);
        return this;
      }
      /**
       * <pre>
      ...
      public Builder putAllPercentages(
        ...
        getMutablePercentages().putAll(values);
        return this;
      }
