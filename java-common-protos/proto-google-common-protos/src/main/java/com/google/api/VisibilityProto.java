...
public final class VisibilityProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    ...
    internal_static_google_api_Visibility_descriptor = getDescriptor().getMessageType(0);
    internal_static_google_api_Visibility_fieldAccessorTable =
    ...
    internal_static_google_api_VisibilityRule_descriptor = getDescriptor().getMessageType(1);
    internal_static_google_api_VisibilityRule_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_api_VisibilityRule_descriptor,
            new java.lang.String[] {
    ...
    enumVisibility.internalInit(descriptor.getExtension(0));
    valueVisibility.internalInit(descriptor.getExtension(1));
    fieldVisibility.internalInit(descriptor.getExtension(2));
    messageVisibility.internalInit(descriptor.getExtension(3));
    methodVisibility.internalInit(descriptor.getExtension(4));
    apiVisibility.internalInit(descriptor.getExtension(5));
