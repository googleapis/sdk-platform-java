    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 202:
            {
              com.google.cloud.audit.PolicyViolationInfo.Builder subBuilder = null;
              if (policyViolationInfo_ != null) {
                subBuilder = policyViolationInfo_.toBuilder();
              }
              policyViolationInfo_ =
                  input.readMessage(
                      com.google.cloud.audit.PolicyViolationInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(policyViolationInfo_);
                policyViolationInfo_ = subBuilder.buildPartial();
              }
