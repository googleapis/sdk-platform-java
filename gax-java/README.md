...
```Groovy
compile 'com.google.api:gax:2.70.3',
  'com.google.api:gax-grpc:2.70.3'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.api" % "gax" % "2.70.3"
libraryDependencies += "com.google.api" % "gax-grpc" % "2.70.3"
```
