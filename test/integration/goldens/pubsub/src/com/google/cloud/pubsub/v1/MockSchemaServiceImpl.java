  ...
  public void validateSchema(
    ...
    if (response instanceof ValidateSchemaResponse) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ValidateSchema, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  ValidateSchemaResponse.class.getName(),
                  Exception.class.getName())));
    }
  }
  ...
  public void validateMessage(
    ...
    if (response instanceof ValidateMessageResponse) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ValidateMessage, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  ValidateMessageResponse.class.getName(),
                  Exception.class.getName())));
    }
  }
}
