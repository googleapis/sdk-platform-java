 ...
 *      <td>Detaches a subscription from this topic. All messages retained in the
 *  subscription are dropped. Subsequent `Pull` and `StreamingPull` requests
 *  will return FAILED_PRECONDITION. If the subscription is a push
 *  subscription, pushes to the endpoint will stop.</td>
 *      <td>
 *      <p>Request object method variants only takes one parameter, a request object, which must be constructed before the call.</p>
 *
 *      <ul>
 ...
 *    <tr>
 *      <td>CreateTopic</td>
 *      <td>Creates the given topic with the given name. See the [resource name rules]
 *  (https://cloud.google.com/pubsub/docs/admin#resource_names).</td>
 *      <td>
 *      <p>Request object method variants only takes one parameter, a request object, which must be constructed before the call.</p>
 *
 *      <ul>
 ...
 *    <tr>
 *      <td>UpdateTopic</td>
 *      <td>Updates an existing topic. Note that certain properties of a
 *  topic are not modifiable.</td>
 *      <td>
 *      <p>Request object method variants only takes one parameter, a request object, which must be constructed before the call.</p>
 *
 *      <ul>
 ...
 *    <tr>
 *      <td>DeleteTopic</td>
 *      <td>Deletes the topic with the given name. Returns `NOT_FOUND` if the topic
 *  does not exist. After a topic is deleted, a new topic may be created with
 *  the same name; this is an entirely new topic with none of the old
 *  configuration or subscriptions. Existing subscriptions to this topic are
 *  not deleted, but their `topic` field is set to `_deleted-topic_`.</td>
 *      <td>
 *      <p>Request object method variants only takes one parameter, a request object, which must be constructed before the call.</p>
 *
 *      <ul>
 ...
 *      <td>Lists the names of the snapshots on this topic. Snapshots are used in
 ...
 *    <tr>
 *      <td>Publish</td>
 *      <td>Adds one or more messages to the topic. Returns `NOT_FOUND` if the topic
 *  does not exist.</td>
 *      <td>
 *      <p>Request object method variants only takes one parameter, a request object, which must be constructed before the call.</p>
 *
