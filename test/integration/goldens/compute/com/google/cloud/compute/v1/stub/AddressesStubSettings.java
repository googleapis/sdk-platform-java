...
public class AddressesStubSettings extends StubSettings<AddressesStubSettings> {
  ...
  private final UnaryCallSettings<AggregatedListAddressesRequest, AddressAggregatedList>
      aggregatedListSettings;
  ...
  private final UnaryCallSettings<ListAddressesRequest, AddressList> listSettings;
  ...
  public static class Builder extends StubSettings.Builder<AddressesStubSettings, Builder> {
    ...
    private final UnaryCallSettings.Builder<AggregatedListAddressesRequest, AddressAggregatedList>
        aggregatedListSettings;
    ...
    private final UnaryCallSettings.Builder<ListAddressesRequest, AddressList> listSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      aggregatedListSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
