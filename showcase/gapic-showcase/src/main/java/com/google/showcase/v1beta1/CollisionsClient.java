 ...
 * }</pre>
 *
 * <p>Note: close() needs to be called on the CollisionsClient object to clean up resources such as
 ...
 *
 * <p>This class can be customized by passing in a custom instance of CollisionsSettings to
 * create(). For example:
 *
...
public class CollisionsClient implements BackgroundResource {
  private final CollisionsSettings settings;
  private final CollisionsStub stub;
  private final OperationsClient httpJsonOperationsClient;
  private final com.google.longrunning.OperationsClient operationsClient;

  /** Constructs an instance of CollisionsClient with default settings. */
  public static final CollisionsClient create() throws IOException {
    return create(CollisionsSettings.newBuilder().build());
  }

  /**
   * Constructs an instance of CollisionsClient, using the given settings. The channels are created
   * based on the settings passed in, or defaults for any settings that are not set.
   */
  public static final CollisionsClient create(CollisionsSettings settings) throws IOException {
    return new CollisionsClient(settings);
  }

  /**
   * Constructs an instance of CollisionsClient, using the given stub for making calls. This is for
   * advanced usage - prefer using create(CollisionsSettings).
   */
  public static final CollisionsClient create(CollisionsStub stub) {
    return new CollisionsClient(stub);
  }

  /**
   * Constructs an instance of CollisionsClient, using the given settings. This is protected so that
   * it is easy to make a subclass, but otherwise, the static factory methods should be preferred.
   */
  protected CollisionsClient(CollisionsSettings settings) throws IOException {
    this.settings = settings;
    this.stub = ((CollisionsStubSettings) settings.getStubSettings()).createStub();
    this.operationsClient =
        com.google.longrunning.OperationsClient.create(this.stub.getOperationsStub());
    this.httpJsonOperationsClient = OperationsClient.create(this.stub.getHttpJsonOperationsStub());
  }

  protected CollisionsClient(CollisionsStub stub) {
    this.settings = null;
    this.stub = stub;
    this.operationsClient =
        com.google.longrunning.OperationsClient.create(this.stub.getOperationsStub());
  ...
  public final CollisionsSettings getSettings() {
    return settings;
  }

  public CollisionsStub getStub() {
    return stub;
  }
   ...
   * }</pre>
   */
  public final UnaryCallable<Request, Operation> doSomethingCallable() {
    return stub.doSomethingCallable();
  }
