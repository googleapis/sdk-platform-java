...
public class WickedSettings extends ClientSettings<WickedSettings> {
  ...
  public PagedCallSettings<ListLocationsRequest, ListLocationsResponse, ListLocationsPagedResponse>
    ...
    return ((WickedStubSettings) getStubSettings()).listLocationsSettings();
  }

  /** Returns the object with the settings used for calls to getLocation. */
  public UnaryCallSettings<GetLocationRequest, Location> getLocationSettings() {
    return ((WickedStubSettings) getStubSettings()).getLocationSettings();
  }
  ...
  public static InstantiatingHttpJsonChannelProvider.Builder
    ...
    return WickedStubSettings.defaultHttpJsonTransportProviderBuilder();
  }
  ...
  public static class Builder extends ClientSettings.Builder<WickedSettings, Builder> {
    ...
    private static Builder createHttpJsonDefault() {
      return new Builder(WickedStubSettings.newHttpJsonBuilder());
    }
