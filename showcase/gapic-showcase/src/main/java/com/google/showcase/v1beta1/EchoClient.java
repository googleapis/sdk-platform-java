...
public class EchoClient implements BackgroundResource {
   ...
   *   for (Operation element : echoClient.listOperations(name, filter).iterateAll()) {
   *     // doThingsWith(element);
   *   }
   * }
   * }</pre>
   ...
   *           .setPageToken("pageToken873572522")
   *           .build();
   *   for (Operation element : echoClient.listOperations(request).iterateAll()) {
   *     // doThingsWith(element);
   *   }
   * }
   * }</pre>
   ...
   *           .setPageToken("pageToken873572522")
   *           .build();
   *   ApiFuture<Operation> future = echoClient.listOperationsPagedCallable().futureCall(request);
   *   // Do something.
   ...
   *           .build();
   *   while (true) {
   *     ListOperationsResponse response = echoClient.listOperationsCallable().call(request);
   ...
   * try (EchoClient echoClient = EchoClient.create()) {
   *   String name = "name3373707";
   *   Operation response = echoClient.getOperation(name);
   * }
   * }</pre>
   *
   ...
   *   Operation response = echoClient.getOperation(request);
   * }
   * }</pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   ...
   * try (EchoClient echoClient = EchoClient.create()) {
   *   GetOperationRequest request = GetOperationRequest.newBuilder().setName("name3373707").build();
   *   ApiFuture<Operation> future = echoClient.getOperationCallable().futureCall(request);
   *   // Do something.
   *   Operation response = future.get();
   * }
   * }</pre>
   ...
   * try (EchoClient echoClient = EchoClient.create()) {
   *   String name = "name3373707";
   *   echoClient.deleteOperation(name);
   * }
   * }</pre>
   *
   ...
   *   echoClient.deleteOperation(request);
   * }
   * }</pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   ...
   *   DeleteOperationRequest request =
   *       DeleteOperationRequest.newBuilder().setName("name3373707").build();
   *   ApiFuture<Empty> future = echoClient.deleteOperationCallable().futureCall(request);
   *   // Do something.
   *   future.get();
   * }
   * }</pre>
   ...
   * try (EchoClient echoClient = EchoClient.create()) {
   *   String name = "name3373707";
   *   echoClient.cancelOperation(name);
   * }
   * }</pre>
   *
   ...
   *   echoClient.cancelOperation(request);
   * }
   * }</pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   ...
   *   CancelOperationRequest request =
   *       CancelOperationRequest.newBuilder().setName("name3373707").build();
   *   ApiFuture<Empty> future = echoClient.cancelOperationCallable().futureCall(request);
   *   // Do something.
   *   future.get();
   * }
   * }</pre>
