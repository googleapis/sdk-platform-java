...
public class CollisionsClientTest {
  private static MockCollisions mockCollisions;
  private static MockLocations mockLocations;
  private static MockServiceHelper mockServiceHelper;
  private LocalChannelProvider channelProvider;
  private CollisionsClient client;

  @BeforeClass
  public static void startStaticServer() {
    mockCollisions = new MockCollisions();
    mockLocations = new MockLocations();
    mockServiceHelper =
        new MockServiceHelper(
            UUID.randomUUID().toString(),
            Arrays.<MockGrpcService>asList(mockCollisions, mockLocations));
  ...
  public void doSomethingTest() throws Exception {
    ...
    Operation resultOperation =
        Operation.newBuilder()
            ...
            .build();
    mockCollisions.addResponse(resultOperation);
    ...
    Request actualRequest = ((Request) actualRequests.get(0));
  ...
  @Test
  public void doSomethingExceptionTest() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockCollisions.addException(exception);
