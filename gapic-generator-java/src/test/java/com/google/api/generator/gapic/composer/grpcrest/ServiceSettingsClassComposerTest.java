...
public class ServiceSettingsClassComposerTest {
  ...
  public void generateServiceClasses() {
    ...
    GoldenTestHelper.saveCodegenToFile(this.getClass(), "EchoSettings.golden", visitor.write());
    Path goldenFilePath =
        Paths.get(GoldenTestHelper.getGoldenDir(this.getClass()), "EchoSettings.golden");
  ...
  public void generateServiceClassesWicked() {
    ...
    JavaWriterVisitor visitor = new JavaWriterVisitor();
    clazz.classDefinition().accept(visitor);
    GoldenTestHelper.saveCodegenToFile(this.getClass(), "WickedSettings.golden", visitor.write());
    Path goldenFilePath =
        Paths.get(GoldenTestHelper.getGoldenDir(this.getClass()), "WickedSettings.golden");
    Assert.assertCodeEquals(goldenFilePath, visitor.write());
  }
}
