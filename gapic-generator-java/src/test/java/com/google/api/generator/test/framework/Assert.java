...
public class Assert {
  ...
  public static void assertGoldenClass(Class<?> clazz, GapicClass gapicClass, String fileName) {
    ...
    GoldenTestHelper.saveCodegenToFile(clazz, fileName, visitor.write());
    Path goldenFilePath = Paths.get(GoldenTestHelper.getGoldenDir(clazz), fileName);
  ...
  public static void assertGoldenSamples(
    ...
    for (Sample sample : samples) {
      ...
      String goldenSampleDir =
          GoldenTestHelper.getGoldenDir(clazz) + "/samples/" + sampleDirName.toLowerCase() + "/";
      ...
      GoldenTestHelper.saveSampleCodegenToFile(
