...
public abstract class RegionTag {
  ...
  public abstract static class Builder {
    ...
    // For autogenerated Phase 1 snippets, tagType = "generated"
    // For configured autogenerated Phase 2 snippets, tagType = "config"
    public abstract Builder setTagType(String tagType);

    // Only set for configured autogenerated Phase 2 snippets
    public abstract Builder setConfigId(String configId);
