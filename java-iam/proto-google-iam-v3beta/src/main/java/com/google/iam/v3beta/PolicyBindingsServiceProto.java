  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\023CreatePolicyBinding\022-.google.iam.v3beta.CreatePolicyBindingReque"
          + "st\032\035.google.longrunning.Operation\"\266\002\202\323\344\223"
          + "\002\340\001\"6/v3beta/{parent=projects/*/location"
          + "s/*}/policyBindings:\016policy_bindingZG\"5/v3beta/{parent=folders/*/locations/*}/po"
          + "licyBindings:\016policy_bindingZM\";/v3beta/{parent=organizations/*/locations/*}/pol"
          + "icyBindings:\016policy_binding\332A\'parent,policy_binding,policy_binding_id\312A\"\n\r"
          + "PolicyBinding\022\021OperationMetadata\022\241\002\n"
          + "\020GetPolicyBinding\022*.google.iam.v3beta.GetPolicyBindingRequest\032"
          + " .google.iam.v3beta.PolicyBi"
          + "nding\"\276\001\202\323\344\223\002\260\001\0226/v3beta/{name=projects/"
          + "*/locations/*/policyBindings/*}Z7\0225/v3beta/{name=folders/*/locations/*/policyBin"
          + "dings/*}Z=\022;/v3beta/{name=organizations/"
          + "*/locations/*/policyBindings/*}\332A\004name\022\274\003\n"
          + "\023UpdatePolicyBinding\022-.google.iam.v3be"
          + "ta.UpdatePolicyBindingRequest\032\035.google.l"
          + "ongrunning.Operation\"\326\002\202\323\344\223\002\215\0022E/v3beta/"
          + "{policy_binding.name=projects/*/locations/*/policyBindings/*}:\016policy_bindingZV2"
          + "D/v3beta/{policy_binding.name=folders/*/locations/*/policyBindings/*}:\016policy_bi"
          + "ndingZ\\2J/v3beta/{policy_binding.name=organizations/*/locations/*/policyBindings"
          + "/*}:\016policy_binding\332A\032policy_binding,update_mask\312A\"\n\r"
          + "PolicyBinding\022\021OperationMetadata\022\321\002\n"
          + "\023DeletePolicyBinding\022-.google.iam.v3beta.DeletePolicyBindingRequest\032\035.g"
          + "oogle.longrunning.Operation\"\353\001\202\323\344\223\002\260\001*6/"
          + "v3beta/{name=projects/*/locations/*/policyBindings/*}Z7*5/v3beta/{name=folders/*"
          + "/locations/*/policyBindings/*}Z=*;/v3bet"
          + "a/{name=organizations/*/locations/*/policyBindings/*}\332A\004name\312A*\n"
          ...
          + "olicyBindingsResponse\"\300\001\202\323\344\223\002\260\001\0226/v3beta"
          + "/{parent=projects/*/locations/*}/policyBindingsZ7\0225/v3beta/{parent=folders/*/loc"
          + "ations/*}/policyBindingsZ=\022;/v3beta/{par"
          + "ent=organizations/*/locations/*}/policyBindings\332A\006parent\022\244\003\n"
          + "\032SearchTargetPolicyBindings\0224.google.iam.v3beta.SearchTarget"
          + "PolicyBindingsRequest\0325.google.iam.v3bet"
          + "a.SearchTargetPolicyBindingsResponse\"\230\002\202"
          + "\323\344\223\002\201\002\022Q/v3beta/{parent=projects/*/locat"
          + "ions/*}/policyBindings:searchTargetPolicyBindingsZR\022P/v3beta/{parent=folders/*/l"
          + "ocations/*}/policyBindings:searchTargetPolicyBindingsZX\022V/v3beta/{parent=organiz"
          + "ations/*/locations/*}/policyBindings:searchTargetPolicyBindings\332A\r"
          + "parent,target\032"
