  ...
  static {
    java.lang.String[] descriptorData = {
      "\nBgoogle/iam/v3beta/principal_access_bou"
          ...
          + "\"\371\001\202\323\344\223\002p\"L/v3beta/{parent=organizations"
          + "/*/locations/*}/principalAccessBoundaryP"
          + "olicies: principal_access_boundary_polic"
          + "y\332AKparent,principal_access_boundary_pol"
          + "icy,principal_access_boundary_policy_id\312"
          + "A2\n\035PrincipalAccessBoundaryPolicy\022\021Opera"
          ...
          + "[\202\323\344\223\002N\022L/v3beta/{name=organizations/*/l"
          + "ocations/*/principalAccessBoundaryPolici"
          + "es/*}\332A\004name\022\202\003\n#UpdatePrincipalAccessBo"
          + "undaryPolicy\022=.google.iam.v3beta.UpdateP"
          + "rincipalAccessBoundaryPolicyRequest\032\035.go"
          + "ogle.longrunning.Operation\"\374\001\202\323\344\223\002\221\0012m/v"
          + "3beta/{principal_access_boundary_policy."
          + "name=organizations/*/locations/*/princip"
          + "alAccessBoundaryPolicies/*}: principal_a"
          + "ccess_boundary_policy\332A,principal_access"
          + "_boundary_policy,update_mask\312A2\n\035Princip"
          + "alAccessBoundaryPolicy\022\021OperationMetadat"
          ...
          + "nning.Operation\"\210\001\202\323\344\223\002N*L/v3beta/{name="
          + "organizations/*/locations/*/principalAcc"
          + "essBoundaryPolicies/*}\332A\004name\312A*\n\025google"
          + ".protobuf.Empty\022\021OperationMetadata\022\203\002\n#L"
          ...
          + "e\"]\202\323\344\223\002N\022L/v3beta/{parent=organizations"
          + "/*/locations/*}/principalAccessBoundaryP"
          + "olicies\332A\006parent\022\256\002\n+SearchPrincipalAcce"
          ...
          + "esponse\"p\202\323\344\223\002c\022a/v3beta/{name=organizat"
          + "ions/*/locations/*/principalAccessBounda"
          + "ryPolicies/*}:searchPolicyBindings\332A\004nam"
          + "e\032F\312A\022iam.googleapis.com\322A.https://www.g"
