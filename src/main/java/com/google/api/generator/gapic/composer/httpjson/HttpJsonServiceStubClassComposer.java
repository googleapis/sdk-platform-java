...
public class HttpJsonServiceStubClassComposer extends AbstractServiceStubClassComposer {
    ...
    MethodInvocationExpr expr =
        MethodInvocationExpr.builder()
            ...
            .setStaticReferenceType(
                getFixedTypeStore().get(ApiMethodDescriptor.class.getSimpleName()))
  ...
  protected Expr createTransportSettingsInitExpr(
    ...
    MethodInvocationExpr callSettingsBuilderExpr =
        MethodInvocationExpr.builder()
            .setStaticReferenceType(
                getFixedTypeStore().get(HttpJsonCallSettings.class.getSimpleName()))
  ...
  protected List<MethodDefinition> createGetMethodDescriptorsMethod(
                ...
                .setType(
                    TypeNode.withReference(
                        ConcreteReference.builder()
                            ...
                            .setGenerics(
                                Arrays.asList(
                                    getFixedTypeStore().get("ApiMethodDescriptor").reference()))
                            .build()))
        ...
        AssignmentExpr.builder()
            ...
            .setValueExpr(
                NewObjectExpr.builder()
                    .setType(getFixedTypeStore().get("ArrayList"))
                    .setIsGeneric(true)
                    .build())
            .build());
    ...
    return Arrays.asList(
        MethodDefinition.builder()
            ...
            .setAnnotations(
                Arrays.asList(AnnotationNode.withType(getFixedTypeStore().get("InternalApi"))))
  ...
  private List<Expr> getRequestFormatterExpr(Method protoMethod) {
    ...
    MethodInvocationExpr expr =
        MethodInvocationExpr.builder()
            .setStaticReferenceType(
                getFixedTypeStore().get(ProtoMessageRequestFormatter.class.getSimpleName()))
            .setMethodName("newBuilder")
    ...
    expr =
        methodMaker
            .apply(
                ...
                Arrays.asList(
                    ValueExpr.withValue(
                        StringObjectValue.withValue(protoMethod.httpBindings().pattern())),
  ...
  private List<Expr> setResponseParserExpr(Method protoMethod) {
    ...
    MethodInvocationExpr expr =
        MethodInvocationExpr.builder()
            .setStaticReferenceType(
                getFixedTypeStore().get(ProtoMessageResponseParser.class.getSimpleName()))
            .setMethodName("newBuilder")
  ...
  private Expr createFieldsExtractorAnonClass(
    ...
    if (!extractorReturnType.isProtoPrimitiveType()) {
      ...
      Expr fieldsAssignExpr =
          AssignmentExpr.builder()
              ...
              .setValueExpr(
                  NewObjectExpr.builder()
                      .setType(getFixedTypeStore().get(HashMap.class.getSimpleName()))
                      .setIsGeneric(true)
                      .build())
              .build();
    ...
    Expr serializerAssignExpr =
        AssignmentExpr.builder()
            ...
            .setValueExpr(
                MethodInvocationExpr.builder()
                    .setStaticReferenceType(
                        getFixedTypeStore().get(ProtoRestSerializer.class.getSimpleName()))
    ...
    if (httpBindingFieldNames.isEmpty()) {
      bodyExprs = Collections.emptyList();
