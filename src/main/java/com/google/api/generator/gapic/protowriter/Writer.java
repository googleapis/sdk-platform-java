...
public class Writer {
  ...
  // This is for the prototype only, will need to be updated to mimic current autogenerated snippet
  // directory
  // TODO: @alicejli update this once it's been decided where these snippets should live relative to
  // the non-configured autogenerated snippets
  private static void writeConfiguredSnippets(
      GapicContext context, GapicPackageInfo gapicPackageInfo, JarOutputStream jos) {
