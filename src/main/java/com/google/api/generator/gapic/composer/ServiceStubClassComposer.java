            ...
            method -> {
              ...
              switch (method.stream()) {
                ...
                case NONE:
                  // Fall through.
                default:
                  returnType = types.get("UnaryCallable");
              }

              String methodName =
                  String.format("%sCallable", JavaStyle.toLowerCamelCase(method.name()));
              ...
              returnType =
                  TypeNode.withReference(returnType.reference().copyAndSetGenerics(genericRefs));
