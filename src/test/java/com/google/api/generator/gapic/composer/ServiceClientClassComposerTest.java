...
public class ServiceClientClassComposerTest {
  ...
  public void generateServiceClasses() throws IOException {
    ...
    Utils.saveCodegenToFile(this.getClass(), "ServiceClientClass.golden", visitor.write());
    Path goldenFilePath =
        Paths.get(ComposerConstants.GOLDENFILES_DIRECTORY, "ServiceClientClass.golden");
