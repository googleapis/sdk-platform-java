...
# This script will perform the following actionswhen a pull request
# changes the generation configuration (generation_config.yaml by default):
...
# 2. Compare the generation configurations in the current branch (with which the
...
# 5. Edit the PR body with the generated pull request description, if applicable.
