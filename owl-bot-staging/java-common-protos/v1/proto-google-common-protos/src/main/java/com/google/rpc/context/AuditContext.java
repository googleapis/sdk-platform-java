...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasScrubbedRequest()) {
      if (!getScrubbedRequest()
          .equals(other.getScrubbedRequest())) return false;
    }
    if (hasScrubbedResponse() != other.hasScrubbedResponse()) return false;
    if (hasScrubbedResponse()) {
      if (!getScrubbedResponse()
          .equals(other.getScrubbedResponse())) return false;
    }
    if (getScrubbedResponseItemCount()
        != other.getScrubbedResponseItemCount()) return false;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.rpc.context.AuditContext result) {
      ...
      if (((from_bitField0_ & 0x00000002) != 0)) {
        result.scrubbedRequest_ = scrubbedRequestBuilder_ == null
            ? scrubbedRequest_
            : scrubbedRequestBuilder_.build();
      }
      if (((from_bitField0_ & 0x00000004) != 0)) {
        result.scrubbedResponse_ = scrubbedResponseBuilder_ == null
            ? scrubbedResponse_
            : scrubbedResponseBuilder_.build();
      }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              input.readMessage(
                  getScrubbedRequestFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 26: {
              input.readMessage(
                  getScrubbedResponseFieldBuilder().getBuilder(),
                  extensionRegistry);
