  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "a1.RepeatResponse\"p\202\323\344\223\002j\022h/v1beta1/repeat/{info.f_string}/{info.f_int32}/{info.f_double}/{info.f_bool}/{info.f_kingdom}:simplepath\022\323\002\n"
          ...
          + "g=first/*}/{info.f_child.f_string=second/*}/bool/{info.f_bool}:pathresourceZt\022r/v1beta1/repeat/{info.f_child.f_string=first/*}/{info.f_string=second/*}/bool/{info.f_bool}:childfirstpathresource\022\331\001\n"
          + "\036RepeatDataPathTrailingResource\022&.google.sh"
          + "owcase.v1beta1.RepeatRequest\032\'.google.sh"
          + "owcase.v1beta1.RepeatResponse\"f\202\323\344\223\002`\022^/v1beta1/repeat/{info.f_string=first/*}/{info.f_child.f_string=second/**}:pathtrailingresource\022\210\001\n"
