...
public final class CreateStreamingSequenceRequest extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10:
            {
              com.google.showcase.v1beta1.StreamingSequence.Builder subBuilder = null;
              if (streamingSequence_ != null) {
                subBuilder = streamingSequence_.toBuilder();
              }
              streamingSequence_ =
                  input.readMessage(
                      com.google.showcase.v1beta1.StreamingSequence.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(streamingSequence_);
                streamingSequence_ = subBuilder.buildPartial();
              }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public com.google.showcase.v1beta1.CreateStreamingSequenceRequest buildPartial() {
      ...
      if (streamingSequenceBuilder_ == null) {
        result.streamingSequence_ = streamingSequence_;
      } else {
        result.streamingSequence_ = streamingSequenceBuilder_.build();
      }
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.showcase.v1beta1.CreateStreamingSequenceRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage =
            (com.google.showcase.v1beta1.CreateStreamingSequenceRequest) e.getUnfinishedMessage();
     ...
     */
    public boolean hasStreamingSequence() {
      return streamingSequenceBuilder_ != null || streamingSequence_ != null;
    }
    ...
    public Builder mergeStreamingSequence(com.google.showcase.v1beta1.StreamingSequence value) {
      if (streamingSequenceBuilder_ == null) {
        if (streamingSequence_ != null) {
          streamingSequence_ =
              com.google.showcase.v1beta1.StreamingSequence.newBuilder(streamingSequence_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          streamingSequence_ = value;
  ...
  private static final com.google.protobuf.Parser<CreateStreamingSequenceRequest> PARSER =
      new com.google.protobuf.AbstractParser<CreateStreamingSequenceRequest>() {
        ...
        public CreateStreamingSequenceRequest parsePartialFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws com.google.protobuf.InvalidProtocolBufferException {
          return new CreateStreamingSequenceRequest(input, extensionRegistry);
        }
      };
